 ...
 *
 * The original HTML is preserved verbatim as a static shell; every
 * `{{mustache}}` placeholder is interpolated from `InvoiceEmailProps`.
...
export const InvoiceEmail: ITemplate<InvoiceEmailProps> = {
  ...
  render: ({
    ...
    // -----------------------------------------------------------------------
    // Render the itemized invoice rows from the typed array. This replaces
    // the Handlebars `{{#each invoice_details}} ... {{/each}}` block.
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // Full document — markup and <style> block kept 1:1 with the source
    // reference so visual output is identical, only placeholders swapped.
    // -----------------------------------------------------------------------
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi ${name},</h1>
                        <p>Thanks for using ${product_name}. This is an invoice for your recent purchase.</p>
