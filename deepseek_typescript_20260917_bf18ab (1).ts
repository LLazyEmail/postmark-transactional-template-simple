...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <span class="preheader">${preheader ?? `Welcome to ${product_name ?? 'us'}, ${userName}!`}</span>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        ${
                          support_url
                            ? `<p>If you have any questions, reach out to our <a href="${support_url}">support team</a>.</p>`
                            : ''
                        }
                          ...
                          <tr>
                            <td align="center">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="${action_url}" class="f-fallback button button--green" target="_blank">${action_label ?? 'Get Started'}</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                  ...
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">
                        ${company_name ?? ''}
                        ${company_address ? `<br>${company_address}` : ''}
                        ${company_suite ? `<br>${company_suite}` : ''}
                      </p>
                    </td>
                  </tr>
                </table>
