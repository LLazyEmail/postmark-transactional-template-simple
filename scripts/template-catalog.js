...
const SAMPLE_PAYLOADS = {
  ...
  WelcomeEmail: {
    ...
    preheader: 'Welcome aboard — confirm your email to get started.',
  ...
  InvoiceEmail: {
    name: 'Alex',
    preheader: 'This is an invoice for your purchase on Jan 5, 2026.',
...
module.exports = { CATALOG, SAMPLE_PAYLOADS };
